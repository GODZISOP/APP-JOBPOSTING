          ...
          <TouchableOpacity style={styles.loginBtn} onPress={handleLogin} activeOpacity={0.88} disabled={loading}>
            {loading ? (
              ...
              <>
                ...
                <Ionicons name="arrow-forward" size={18} color={theme.textPrimary} style={{ marginLeft: 6 }} />
              </>
            )}
          </TouchableOpacity>
...
function getStyles(theme) { return StyleSheet.create({
  ...
  logoCircle: {
    ...
    borderWidth: 1, borderColor: theme.isDark ? 'rgba(255, 255, 255, 0.1)' : '#E2E8F0',
  ...
  tagline: { fontSize: FONTS.sizes.xs + 1, color: theme.textSecondary, marginTop: 2, textAlign: 'center' },

  card: {
    backgroundColor: theme.isDark ? 'rgba(255, 255, 255, 0.05)' : theme.bgCard, borderRadius: 28,
    padding: 24,
  ...
  googleBtn: {
    ...
    borderWidth: 1.5, borderColor: theme.isDark ? 'rgba(255, 255, 255, 0.1)' : '#E5E7EB',
    borderRadius: 16, height: 52, marginBottom: 16,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.05, shadowRadius: 6, elevation: 0,
  },
  googleIcon: { width: 24, height: 24, marginRight: 10 },
  googleBtnText: { fontSize: FONTS.sizes.sm + 1, fontWeight: '700', color: theme.isDark ? '#FFFFFF' : theme.textPrimary },

  dividerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  dividerLine: { flex: 1, height: 1, backgroundColor: theme.isDark ? 'rgba(255, 255, 255, 0.1)' : '#EEF2F0' },
  dividerText: { fontSize: 12, color: theme.textSecondary, marginHorizontal: 12, fontWeight: '600' },
  ...
  forgotText: { fontSize: FONTS.sizes.sm, color: theme.accentGreen, fontWeight: '700' },
  ...
  loginBtnText: { fontSize: FONTS.sizes.md + 1, fontWeight: '800', color: theme.textPrimary },

  signupRow: { flexDirection: 'row', justifyContent: 'center', marginTop: 20 },
  signupText: { fontSize: FONTS.sizes.sm, color: theme.textSecondary, fontWeight: '500' },
  signupLink: { fontSize: FONTS.sizes.sm, fontWeight: '800', color: theme.accentGreen },
}); }
